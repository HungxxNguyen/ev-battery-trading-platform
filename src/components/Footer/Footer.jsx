      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            <Link to="/" className="flex items-center gap-3 justify-center md:justify-start group mb-3">
              <img
                src={logo3}
            ...
            <p className="text-sm leading-relaxed text-blue-200">
              VoltX Exchange connects buyers and sellers of second-hand electric vehicles and batteries. We make trading safer, simpler, and more transparent with verified listings and secure transactions.
            </p>
          </div>

          {/* Column 2: Quick Links */}
          <div className="text-center md:text-left">
            <h4 className="text-xl font-semibold mb-3 text-cyan-300">Quick Links</h4>
          ...
          <div className="text-center md:text-left">
            <h4 className="text-xl font-semibold mb-3 text-cyan-300">Contact</h4>
            <p className="text-sm mb-1 text-blue-200">Email: support@voltx.exchange</p>
            <p className="text-sm mb-1 text-blue-200">Phone: (+84) 123 456 789</p>
            <p className="text-sm text-blue-200">Address: 123 Green Road, Ho Chi Minh City, Vietnam</p>
        ...
        <div className="mt-8 pt-8 border-t border-cyan-500/30 text-center text-sm">
          <p className="text-blue-200">© {new Date().getFullYear()} VoltX Exchange. All rights reserved.</p>
          <div className="mt-2 space-x-4">
            <Link to="/terms" className="relative text-blue-200 hover:text-cyan-300 transition-all duration-300 group">
              Terms
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-cyan-400 group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link to="/privacy" className="relative text-blue-200 hover:text-cyan-300 transition-all duration-300 group">
              Privacy
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-cyan-400 group-hover:w-full transition-all duration-300"></span>
            </Link>
            <Link to="/safety" className="relative text-blue-200 hover:text-cyan-300 transition-all duration-300 group">
              Safety
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-cyan-400 group-hover:w-full transition-all duration-300"></span>
            </Link>
          </div>
